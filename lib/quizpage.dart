...
import 'package:majorproject/resultpage.dart';
...
class _getjsonState extends State<getjson> {
  ...
  setasset() {
    if (widget.langname == "Flutter") {
      assettoload = "assets/jsonfile/flutter.json";
    } else if (widget.langname == "C++") {
      assettoload = "assets/jsonfile/cpp.json";
    } else if (widget.langname == "Java") {
      assettoload = "assets/jsonfile/java.json";
    } else if (widget.langname == "JavaScript") {
      assettoload = "assets/jsonfile/js.json";
    } else {
      assettoload = "assets/jsonfile/linux.json";
    }
  }
